	...
	<form class="form-horizontal">
		...
		<div class='row vertical-align'>
			<div class='col-md-6'>
				...
				<div class='col-md-offset-1'>
					<input class='form-control' name='txt_recruit_visa'>
				</div>
				...
				<div class='col-md-offset-1'>
					<input class='form-control' name='txt_inbound_no'>
				</div>
			...
			<div class='col-md-6 text-center'>
				<button type="button" class="btn btn-success btn-lg export" rpttype="doc1">
	...
	<form class="form-horizontal">
		...
		<div class='row vertical-align'>
			<div class='col-md-6'>
				...
				<div class='col-md-offset-1'>
					<input class='form-control' name='txt_recruit_visa2'>
				</div>
			</div>
			<div class='col-md-6 text-center'>
				<button type="button" class="btn btn-success btn-lg export" rpttype="doc2">
				<span class="glyphicon glyphicon-share" aria-hidden="true"></span> Export
				</button>
			</div>	
		</div>
