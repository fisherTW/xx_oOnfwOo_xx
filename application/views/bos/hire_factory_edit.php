...
<div class="container">
	<form class="form-horizontal" id='form1' onKeyDown="if(event.keyCode == 13) {return false;}">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation"><a href="#f_req_condition" aria-controls="f_req_condition" role="tab" data-toggle="tab"><?= $lang->line('f_req_condition') ?></a></li>
			<li role="presentation"><a href="#f_work_content" aria-controls="f_work_content" role="tab" data-toggle="tab"><?= $lang->line('f_work_content') ?></a></li>
			<li role="presentation"><a href="#f_salary_condition" aria-controls="f_salary_condition" role="tab" data-toggle="tab"><?= $lang->line('f_salary_condition') ?></a></li>
		</ul>
		<!-- Tab panes -->
...
<?php endif; ?>
			...
			<!-- tab 4 -->
			<div role="tabpanel" class="tab-pane" id="f_req_condition">
				<div class="form-group">
					<div class="col-sm-6">
...
<?php endif; ?>	
				...
				<div class="form-group">
					<div class="col-sm-6">
						<label class="control-label"><?= $lang->line('f_file_path2') ?></label>
						<div>
<?php if (strval($id) != '0'): ?>
...
<?php endif; ?>	
			...
			<!-- tab 5 -->
			<div role="tabpanel" class="tab-pane" id="f_work_content">
				<div class="form-group">
					<div class="col-sm-6">
...
<?php endif; ?>	
			...
			<!-- tab 6 -->
			<div role="tabpanel" class="tab-pane" id="f_salary_condition">
<!--				
				<div class="form-group">
					<div class="col-sm-5">
						...
						<table class="table table-bordered table-hover table-responsive" id="tab_hire_salary">
							<thead>
								<tr >
									...
									<th width="15%" class="text-center text-nowrap"><?= $lang->line('hire_type') ?></th>
									<th width="20%" class="text-center text-nowrap"><?= $lang->line('hire_item') ?></th>
									<th width="30%" class="text-center text-nowrap"><?= $lang->line('hire_money') ?></th>
								</tr>
							</thead>
							<tbody>
<? $row=0; ?>								
