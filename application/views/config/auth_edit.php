...
<div class="container">
	<form class="form-horizontal" id='form1'>
		...
		<div class="form-group" style='display:none;'>
			<label for="inputPassword3" class="col-sm-2 control-label"><?= $lang->line('authcode') ?></label>
			<div class="col-sm-10">
<?php if (strval($id) != '0'): ?>
...
<?php endif; ?>	
		...
		<div class="form-group">
			<label for="inputPassword3" class="col-sm-2 control-label"><?= $lang->line('authname') ?></label>
			<div class="col-sm-10">
<?php if (strval($id) != '0'): ?>
...
$(function () {
	$(".btn-cancel").bind("click",function(){
		window.location = '<?= base_url()?>config/auth';
	});	
	$("#btn_save").bind("click",function(){
		...
		$.ajax({
			type: "POST",
			url: $('#hid_baseurl').val() + 'config/auth_doEdit',
