		...
		<script src='<?= base_url()?>assets/js/industry_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config/industry_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config/apiGetIndustry',
		sortName:"tw",
		sortOrder:"asc",
