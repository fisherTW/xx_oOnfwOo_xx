		...
		<script src='<?= base_url()?>assets/js/emp_dep_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config/emp_dep_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config/apiGetEmpDep',
		sortName:"tw",
		sortOrder:"asc",
