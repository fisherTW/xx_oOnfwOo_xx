		...
		<script src='<?= base_url()?>assets/js/talkmethod_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config2/talkmethod_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config2/apiGetTalkmethod',
		sortName:"tw",
		sortOrder:"asc",
		...
		columns: [{
			field:'tw' ,
			title: "<?= $lang->line('talkmethodname') ?>",
			halign:"left" ,
			align:"left" ,
			sortable:"true" ,
			width:"30%",
