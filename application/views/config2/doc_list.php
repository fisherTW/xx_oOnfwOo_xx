		...
		<script src='<?= base_url()?>assets/js/doc_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config2/doc_edit/0/<?= $type?>';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config2/apiGetDoc/0/<?= $type?>',
		sortName:"tw",
		sortOrder:"asc",
