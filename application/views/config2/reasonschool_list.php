		...
		<script src='<?= base_url()?>assets/js/reasonschool_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config2/reasonschool_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config2/apiGetReasonschool',
		sortName:"tw",
		sortOrder:"asc",
		...
		columns: [{
			field:'tw' ,
			title: "<?= $lang->line('reasonschoolname') ?>",
			halign:"center" ,
			align:"left" ,
			sortable:"true" ,
			width:"30%",
