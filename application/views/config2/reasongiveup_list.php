		...
		<script src='<?= base_url()?>assets/js/reasongiveup_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config2/reasongiveup_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config2/apiGetReasongiveup',
		sortName:"tw",
		sortOrder:"asc",
		...
		columns: [{
			field:'tw' ,
			title: "<?= $lang->line('reasongiveupname') ?>",
			halign:"center" ,
			align:"left" ,
			sortable:"true" ,
			width:"30%",
