		...
		<script src='<?= base_url()?>assets/js/trans_list.js'></script>
...
$(function () {
	$("#btn_create").bind("click",function(){
		window.location = '<?= base_url()?>config2/trans_edit';
	});	

	$('#tblmain').bootstrapTable({
		toggle:"table",
		idField: 'id',
		url: '<?= base_url()?>config2/apiGetTrans',
		sortName:"tw",
		sortOrder:"asc",
